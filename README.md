...
```shell
$ bin/omnibus clean fluentd
```

Adding the `--purge` purge option removes __ALL__ files generated during the
build including the project install directory (`/opt/fluentd`) and
the package cache directory (`/var/cache/omnibus/pkg`):

```shell
$ bin/omnibus clean fluentd --purge
```
...
[vagrant@ubuntu...] $ cd fluentd
[vagrant@ubuntu...] $ bundle install
[vagrant@ubuntu...] $ ...
[vagrant@ubuntu...] $ bin/omnibus build fluentd
```
